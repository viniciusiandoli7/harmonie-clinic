...
export function buildAnamnesisData(body: PatientPayload): Prisma.PatientAnamnesisCreateWithoutPatientInput {
  return {
    ...
    previousAestheticProcedures: toNullableString(body.previousAestheticProcedures),
    ...
    roacutanDetails: toNullableString(body.roacutanDetails),
    ...
    waterIntake: toNullableString(body.waterIntake),
    ...
    cancerHistory: toBoolean(body.cancerHistory),
    ...
    circulationProblems: toNullableString(body.circulationProblems),
